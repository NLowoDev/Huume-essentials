...
local Zones = {
	CokeField =			{x = 1388.93,	y = 3605.69,	z = 37.94,	name = ('Kokaiini keräys'),		sprite = 501,	color = 40},
	CokeProcessing =	{x = 1391.92,	y = 3605.79,	z = 37.94,	name = ('Kokaiini prosessointi'),	sprite = 478,	color = 40},
	--CokeDealer =		{x = -1101.62,	y = 4940.98,		z = 218.35,	name = ('Kokaiini myynti'),		sprite = 500,	color = 75},
	MethField =			{x = 1563.53,	y = -2131.37,	z = -48.0,	name = ('Metan keräys'),		sprite = 499,	color = 26},
	MethProcessing =	{x = 1574.26,	y = -2128.31,	z = -48.0,	name = ('Metan prosessointi'),	sprite = 499,	color = 26},
	--MethDealer =		{x = 660.76,	y = 1282.47,	z = 360.3,	name = ('meth_dealer'),		sprite = 500,	color = 75},
	WeedField =			{x = 5223.35,	y = -5157.2,	z = 10.36,	name = ('Kannabiksen keräys'),		sprite = 496,	color = 52},
	WeedProcessing =	{x = 5196.11,	y = -5133.83,	z = 2.36,	name = ('Kannabis prosessointi'),	sprite = 496,	color = 52},
	--WeedDealer =		{x = -50.24,	y = 1911.14,	z = 195.71,	name = ('weed_dealer'),		sprite = 500,	color = 75},
	OpiumField =		{x = 2191.04,	y = 5534.83,	z = -50.19,	name = ('Opium keräys'),		sprite = 51,	color = 60},
	OpiumProcessing =	{x = 2728.23,	y = 4145.64,	z = -44.29,	name = ('Opium prosessointi'),	sprite = 51,	color = 60},
	--OpiumDealer =		{x = 138.37,	y = 2295.15,	z = 94.08,	name = ('opium_dealer'),		sprite = 500,	color = 75}
}

AddEventHandler('es:playerLoaded', function(xPlayer) 
    TriggerClientEvent("drugs:info", xPlayer, Zones, CopsConnected)
end)
		...
		if PlayersSellingOpium[source] == true then
			...
			if poochQuantity == 0 then
				...
				elseif CopsConnected == 4 then
					...
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_opium'))
				elseif CopsConnected >= 5 then
					xPlayer.addAccountMoney('black_money', 2650)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_opium'))
				end
